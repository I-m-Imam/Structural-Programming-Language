...
* Iterative control structures (`for`, `while`, `do-while` loops)
...
## 🛠️ Tools & Environment
* **Language:** C
* **Primary Development Environment:** Android smartphone (using apps like **Cxxdroid** and web-based compilers, showcasing that dedication and logic matter more than the device)
* **Version Control:** GitHub Mobile / Web interface
